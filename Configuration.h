...
#define STRING_CONFIG_H_AUTHOR "(flashQarl config)" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 32.32
  #define DEFAULT_bedKi 6.20
  #define DEFAULT_bedKd 112.30
...
#define XY_PROBE_FEEDRATE (133*60*10)
...
#define LEVEL_BED_CORNERS
  ...
  #define LEVEL_CORNERS_HEIGHT      0.03   // (mm) Z height of nozzle at leveling points
...
//
#define PREHEAT_1_LABEL       "Giantarm"
#define PREHEAT_1_TEMP_HOTEND 215
#define PREHEAT_1_TEMP_BED     65
#define PREHEAT_1_TEMP_CHAMBER 35
#define PREHEAT_1_FAN_SPEED     0 // Value from 0 to 255

#define PREHEAT_2_LABEL       "Sunlu"
